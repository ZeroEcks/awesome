...
local beautiful = require("beautiful") local vicious = require("vicious")
...
beautiful.init("/home/knighthawk3/.config/awesome/themes/brs/theme.lua")
...
-- tags = {
--   names  = { "work", "code", "irc", "music", "steam", "im", "other", 8, 9 },
...
tags = {
  settings = {
    { names  = { "work", "vim", "ssh", "mail", "irc" },
      layout = { layouts[3], layouts[3], layouts[5], layouts[5], layouts[5]}
    },
    { names  = { "work",  "vim", "im",  "steam", "media" },
      layout = { layouts[3], layouts[3], layouts[5], layouts[1], layouts[4] }
}}}
