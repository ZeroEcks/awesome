...
-- {{{ Colors
theme.fg_normal  = "#ccebee"
theme.fg_focus   = "#369dca"
theme.fg_urgent  = "#81f24c"
...
theme.border_focus  = "#0a75bd"
theme.border_marked = "#CC9393"
-- }}}

-- {{{ Titlebars
theme.titlebar_bg_focus  = "#152a3f"
theme.titlebar_bg_normal = "#152a3f"
-- }}}
...
-- {{{ Misc
theme.awesome_icon           = "~/.config/awesome/themes/brs/awesome-icon.png"
